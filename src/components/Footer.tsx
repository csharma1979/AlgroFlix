    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <img src={logo} alt="AlgroFlix Logo" className="h-12 mb-4" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/staff-augmentation" className="text-gray-400 hover:text-white">Staff Augmentation</Link></li>
              <li><Link to="/it-staff-augmentation" className="text-gray-400 hover:text-white">IT Staff Augmentation</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
          <p>&copy; 2026 AlgroFlix. All rights reserved.</p>
